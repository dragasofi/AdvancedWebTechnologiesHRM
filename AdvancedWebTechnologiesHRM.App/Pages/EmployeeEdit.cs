...
namespace AdvancedWebTechnologiesHRM.App.Pages
{
    public partial class EmployeeEdit
    {
        ...
        protected async Task HandleValidSubmit()
        {
            ...
            {
                //Employee.Country = await CountryDataService.GetCountryById(Employee.CountryId);
                //Employee.JobCategory = await JobCategoryDataService.GetJobCategoryById(Employee.JobCategoryId);
